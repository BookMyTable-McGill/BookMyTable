...
export default {
  ...
  methods: {
    ...
    getRestaurantsByName: function(nameFragment) {
      AXIOS.get(
        "/restaurantsByNameContains?nameFragment=".concat(nameFragment),
        {},
    ...
    getRestaurantsByPrice: function(price) {
      AXIOS.get(
        "/restaurants/price?price=".concat(price),
        {},
        { params: { price: price } }
      )
        .then((response) => {
    ...
    getRestaurantsByPriceRange: function(minPrice, maxPrice) {
      AXIOS.get(
        "/restaurants/price/range?minPrice=".concat(
          minPrice,
          "&maxPrice=",
          maxPrice
        ),
    ...
    getRestaurantsByCuisine: function(cuisine) {
      AXIOS.get(
        "/restaurants/cuisine?cuisine=".concat(cuisine),
        {},
    ...
    getRestaurantsByOptions: function(options) {
      AXIOS.get(
        "/restaurants/options?options=".concat(options),
        {},
    ...
    addToFavorites: function(restaurant) {
      AXIOS.post(
        "/customer/favorite/add?email=".concat(
          this.customer.email,
          "&restoID=",
    ...
    removeFromFavorites: function(restaurant) {
      AXIOS.post(
        "/customer/favorite/remove?email=".concat(
          this.customer.email,
          "&restoID=",
          parseInt(restaurant.id)
        )
