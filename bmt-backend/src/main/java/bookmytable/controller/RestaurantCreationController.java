...
public class RestaurantCreationController {
	...
	@DeleteMapping(value = {"/restaurant/delete", "/restaurant/delete/" })
	public void deleteRestaurant(@RequestParam(name = "id") long id, @RequestParam(name="ownerEmail") String ownerEmail,
