...
Scenario: The owner successfully modifies the name of a restaurant (Normal Flow)
    ...
    And a "restaurant name modified successfully" message is displayed
...
Scenario: The owner does not successfully modify the name of a restaurant because they enter an existing restaurant name (Error Flow)
